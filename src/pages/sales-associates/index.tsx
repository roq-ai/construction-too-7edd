...
import { useRoqClient, useSalesAssociateFindManyWithCount } from 'lib/roq';
...
export function SalesAssociateListPage(props: SalesAssociateListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSalesAssociateFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.sales_associate.delete({ where: { id } });
      await mutate();
    } catch (error) {

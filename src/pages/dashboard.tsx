...
import { SalesAssociateListPage as ShowCaseList } from 'pages/sales-associates';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Sales Associates
                </Text>
                <NextLink href={`sales-associates`} passHref legacyBehavior>
                  <Button

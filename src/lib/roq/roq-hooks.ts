...
export function useSalesAssociateFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSalesAssociateFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sales_associate.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSalesAssociateCount<T extends Prisma.sales_associateCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.sales_associateCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useSalesAssociateCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sales_associate.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSalesAssociateFindManyWithCount<
  T extends Prisma.sales_associateFindManyArgs,
  R extends { data: GetFindResult<Prisma.$sales_associatePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.sales_associateFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSalesAssociateFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sales_associate.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSalesAssociateFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSalesAssociateFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sales_associate.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
